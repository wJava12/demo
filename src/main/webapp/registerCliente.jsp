                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="ml-3 mr-3 p-4">
                                    ...
                                    <form action="clienteMan" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                              <input type="text" name="txtClave" class="form-control" id="inputClave" placeholder="Clave" required>
                                            </div>
                                        </div>
                                               ...
                                               <select class="form-control" name="cargo">
                                                ...
                                                <%
                                                    ...
                                                    List<Cargo> cargos = car.mostrar()
                                                            .stream()
                                                            .filter(e->e.getNombre().equalsIgnoreCase("cliente"))
